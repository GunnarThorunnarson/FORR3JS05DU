...
- [ ] Notaðu [load event](https://developer.mozilla.org/en-US/docs/Web/API/Window/load_event) fyrir Ghost [sprites](https://spicyyoghurt.com/tutorials/html5-javascript-game-development/images-and-sprite-animations) (assets) sem þú notar fyrir leikinn. Sjá einnig [Loading JS and CSS assets](https://wttech.blog/blog/2019/loading-js-and-css-assets/) og [preloading assets](https://www.youtube.com/watch?v=aXwgGj7G7mE&ab_channel=DavidReid)  **(10%)**
