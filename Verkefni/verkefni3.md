...
- [ ] Notaðu [load event](https://developer.mozilla.org/en-US/docs/Web/API/Window/load_event) til að byrja leikinn. [preloading](https://www.youtube.com/watch?v=aXwgGj7G7mE&ab_channel=DavidReid) gagnast okkur td. þegar við erum með e. assets eins og hljóð og [sprites](https://spicyyoghurt.com/tutorials/html5-javascript-game-development/images-and-sprite-animations) (þarf ekki að gera). Skoðaðu líka [Loading JS and CSS assets](https://wttech.blog/blog/2019/loading-js-and-css-assets/). **(10%)**
